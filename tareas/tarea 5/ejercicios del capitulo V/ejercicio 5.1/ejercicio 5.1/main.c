...
/* Cuenta-numeros.
El programa, al recibir como datos un arreglo unidimesnional de tipo entero y un numero entero, determina cuantas veces se encuentr el numero en el arreglo */
