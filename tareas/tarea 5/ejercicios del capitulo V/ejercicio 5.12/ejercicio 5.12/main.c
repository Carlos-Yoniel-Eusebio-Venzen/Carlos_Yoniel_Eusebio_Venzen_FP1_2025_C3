...
/* La funcion Lectura se utiliza para leer un arreglo unidemensional de T elementos de tipo entero. */
{
int I;
for (I = 0; I < T; I++)
{
...
/* La funcion Ordena utiliza el metodo de insercion directa para ordenar los elementos del arreglo unidimensional A. */
{
int AUX, L, I;
for (I = 1; I < T; I++)
{
