...
El programa calcula el producto de dos y almacena el resultado en otro arreglo unidimensioanl */
...
void Lectura(int VEC[], int T)
/* La funcion Lectra se utiliza para leer un arreglo unidimensional de T elementos de tipo entero. */
{
int I;
printf("\n");
for (I = 0; I < T; I++)
