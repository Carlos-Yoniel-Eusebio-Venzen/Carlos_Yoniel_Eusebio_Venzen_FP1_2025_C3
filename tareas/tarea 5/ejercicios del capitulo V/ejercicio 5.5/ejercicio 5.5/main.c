...
El programa, al recibir como datos las calificaciones de un grupo 50 alumnos, obtiene la frecuencia de cada una de las calificaciones y ademas escribe cual es la frecuencia  mas alta. */
...
/* Se llama a la funcion frecuencia, se pasan ambos arregos. */
printf("\nFrecuencia de calificaciones \n");
Impresion(FRE, 6);
Mayor(FRE, 6);
}
...
for (I = 0; I < T; I++)
{
    printf("Ingrese la calificacion -0:5- de alumno %d: ", I+1);
    scanf("%d", &VEC[I]);
}
}
...
/* Esta duncion calcula la frecuencia de calificaciones. */
{
int I;
for (I = 0; I < P; I++)
