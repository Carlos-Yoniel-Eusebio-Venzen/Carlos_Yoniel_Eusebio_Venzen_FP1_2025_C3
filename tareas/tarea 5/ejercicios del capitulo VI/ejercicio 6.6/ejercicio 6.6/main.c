...
/* Esta funcion se utiiliza para intercambiar las columnas del arreglo bidimensional. Observa que el indice correspondiente a las columnas solo se mueve hasta la mitad del arreglo */
{
int I, J;
float AUX;
...
/* La funciin Imprime se utiliza para escribir un arreglo bidimensional de tipo real de F filas y C columnas. */
{
int I, J;;
for (I = 0; I < F; I++)
    for (J = 0; J < C; J++)
