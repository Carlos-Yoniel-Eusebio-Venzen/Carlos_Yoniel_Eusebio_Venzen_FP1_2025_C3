...
/* Asigna.
El programa, al recibir un arreglo bidimensional cuadrado, asigna elementos en funcion del modulo (residuo) a un arreglo unidimensional. */
...
/* esta funcion se utiliza tanto para calcular el modulo entre el indice del arreglo unidimensional y 3, como para llamar a las funciones correpondientes para resolver el problema. */
{
int I;
for (I = 0; I < N; I++)
    switch (I%3)
...
/* Esta funcion se utiliza para escribir un arreglo unidimensional de tipo real de N elementos. */
{
int I;
for (I = 0; I < N; I++)
        printf("\nElemento %d: %.2f ", I, B[I]);
