#include <stdio.h>
/* Empresa textil.
El programa, al recibir un arreglo tridimensional que contiene informacion sobre las ventas mensuales de tres departamentos en los ultimos ocho años, genera informacion estadistica valiosa para la empresa. */
...
/* La funcion lectura se utiliza para leer un arreglo tridimensional de tipo real de F filas, C columnas, P planos de profundidad. */
{
int K, I, J;
for (K = 0; K < P; K++)
    for (I = 0; I < F; I++)
...
/* Esta funcion se utiliza para obtener el departamento que tuvo las mayores ventas en el ultimo año. Genera ademas el importe de las ventas. */
{
int I, J;
...
/* Esta funcion se utiliza para obtener el departamento, mes y año con la mayor venta. Escribe tambien el monto de las ventas. */
{
int K, I, J, DE, ME, AN;
float VEN = -1.0;
for (K = 0; K < P; K++)
