...
/* La funcion Simetrico se utiliza para determinar si el arreglo bidimensional cuadrado es simetrico. Si es simetrico regresa 1, en caso contrario, 0. Observa que en el segundo ciclo solamente se recorre la matriz triangular inferior, sin la diagonal principal. */
{
int I = 0, J = 0, F = 1;
while ((I < T) && F)
{
