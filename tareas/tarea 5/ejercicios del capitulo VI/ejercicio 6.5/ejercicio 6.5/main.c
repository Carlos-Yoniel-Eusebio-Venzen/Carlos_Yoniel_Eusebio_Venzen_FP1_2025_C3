...
do
{
    ...
    scanf("%d", &NAL);
    /* Se vrifica que el numero de alumnos del grupo sea valido. */
}
while (NAL > MAX || NAL < 1);
Lectura(ALU, NAL);
Funcion1(ALU, NAL);
...
/* Esta funcion se utiliza tanto para obtener el promedio de cada examen, asi como tambien el examen que obtuvo el promedio mas alto. */
{
int I, J, MAY;
