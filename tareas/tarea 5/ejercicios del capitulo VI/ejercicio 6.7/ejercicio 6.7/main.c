...
/* Esta funcion se utiliza para calcular el monto de venta anual de cada uno de los productos. Observa que el resultado se almacena en un arreglo unidimensional que se utilizara posteriormente. */
{
int I, J, SUM;
printf("\n");
for (I = 0; I < F; I++)
...
/* Esta funcion se utiiza para obtener el tipo de producto que mas se ha vendido y el monto de las ventas de dicho producto. */
{
int I, TPR = 0;
float VEN = A[0];
for (I = 1; I < C; I++)
...
printf("\n\nTipo de productos mas vendido: %d  \t   Ventas: 5.2f", TPR + 1, VEN);
}
