...
/* Vendedores.
El programa maneja informacion sobre las ventas que realizan los vendedores de articulos domesticos de una importante empresa  de la Ciudad de Mexico. */
...
typedef struct                  /* Declaracion de la estructura vendedor. */
{
    ...
    fpagos pago;                /* pago es de tipo union fpago. */
...
/* Esta funcion se utiliza para leer un arreglo unidimensional de tipo estructura vendendor de T elementos. */
{
int I, J;
for (I = 0; I < T; I++)
{
    ...
    scanf("%f", &A[I].sal);
    printf("Forma de Pago (Banco-1 Nomina-1 Ventanilla-1): ");
    scanf("%d", &A[I].cla);
    switch (A[I].cla)
    {
        case 1:{
