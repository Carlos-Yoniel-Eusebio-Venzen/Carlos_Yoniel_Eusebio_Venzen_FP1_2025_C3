...
/* Para que puedas observar las diferentes formas en que los campos de las variables de tipo estructura alumno reciben valores, ingresamos los valores directamente, los campos de a2 se leen en el programa principal, y los campos de a3 reciben valores a traves de una funcion.  */
printf("Alumno 2\n");
...
scanf("%f", &a2.promedio);
fflush(stdin);
printf("Ingrese el correo electrico: ");
...
/* Escribe el contenido del campo (hgmenez@hotmail.com). */
