...
typedef struct              /* Declaracion de la estrucura matpro. */
{
    char mat[20];   /* Materia. */
    int pro;        /* Promedio. */
}matpro;
...
typedef struct              /* Declaracion de la estructura alumno. */
{
    ...
    matpro cal[5];  /* Observa que cal es un arreglo unidimensional de tipo estructura matpro -la estructura definida en primer termino. */
} alumno;
...
/* Esta funcion se utiliza para leer la informacion de un arreglo unidimensional de tipo estructura alumno de T elementos. */
{
int I, J;
for(I = 0; I < T; I++)
{
