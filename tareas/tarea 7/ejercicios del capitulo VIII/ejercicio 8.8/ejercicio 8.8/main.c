...
/* Esta funcion se utiliza para leer un arreglo unidimensional de tipo estructura paciente de T elementos. */
{
int I;
for (I = 0; I < T; I++)
{
...
/* Esta funcion se utiliza para obtener el porcentaje tanto de hombres como de mujeres registrados en el hospital. */
{
int I, FEM, MAS, TOT;
for (I = 0; I < T; I++)
    switch (A[I].sexo)
...
/* esta funcion se utiliza para obtener el nmero de pacientes que ingresaron al hospital en cada una de las categorias de condicion. */
{
...
/* La funcion F3 se utiliza para generar el nombre y telefono de todos los pacientes que tuvieron una condicion de ingreo de maxima gravedad (5). */
{
int I;
