...
/* Estructuras-1.
El programa muestra la manera en que se declara una estructura, asi como la forma en que se tiene acceso a los campos de las variables de tipo estructura tanto para asignacion de valores como para lectura y escritura. */
...
struct alumno                       /* Declaracion de la estructura. */
{
    ...
    char nombre[20];
    char carrera[20];
    float promedio;                 /* Campos de la estructura. */
    char direccion[20];
};           /* Observa que la declaracion de una estructura termina con punto y coma. */

void main(void)
{
/* Observa que las variables de tipo estructura se declaran como cualquier otra variable. a1, a2 y a3 son variables de tipo de tipo estructura alumno. */
...
/* Observa otra forma de escribir los campos de la variable de tipoi estructura a3. */
printf("\nDatos del alumno 3\n");
