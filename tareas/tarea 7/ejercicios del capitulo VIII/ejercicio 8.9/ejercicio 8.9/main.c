...
/* Bienes raices.
El programa maneja infotmacion sobre las propiedades que  tiene una empresa de bienes raices de la ciudad de Lima, Peru, tanto para venta para renta. */
...
/* Esta funcion se utiliza para leer un arreglo unidimensional de tipo estructura propiedades de T elementos. */
{
int I;
for (I = 0; I < T; I++)
{
...
/* Esta funcion se utiliza para generar un listado de las propiedades disponibles para ventas en la zona de miraflores, cuyo valor oscila entre 450,000 y 650,000 nuevos soles. */
{
int I;
...
/* Al recibir como datos una zona geografica de Lima, Peru, y un cierto rango respecto al monto, esta funcion genera un listado de todas las propiedades disponibles para renta. */
{
int I;
float li, ls;
char zon[20];
