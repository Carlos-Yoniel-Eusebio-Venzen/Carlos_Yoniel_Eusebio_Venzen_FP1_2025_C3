...
/* La funcion Lectura se utiliza para leer un arreglo unidimensional de tipo estructura alumno de T elemntos. */
{
int I, J;
for (I = 0; I < T; I++)
{
...
/* La funcion F2 obtiene las matriculas de los alumnos cuya calificacion en la tercera materia es mayor a 9. */
{
int I;
