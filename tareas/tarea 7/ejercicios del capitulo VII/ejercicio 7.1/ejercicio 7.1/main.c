...
/* Funciones para el manejo de caracteres de la bibliotecas stdio.h */

void main(void)
{
char p1, p2, p3 = '$';
/*Declaracion de las variables tipo caracter p1, p2 y p3. Observa que a p3 se le asigna el simbolo  $. */
printf("\nIngrese un caracter: ");
