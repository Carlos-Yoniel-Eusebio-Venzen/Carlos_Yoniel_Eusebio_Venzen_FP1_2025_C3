...
/* Cuenta cadenas.
El programa, al recibir dos cadenas de caracteres, calcula e imprime cuantas veces se encuentra la segunda cadena en la primera. */
...
/* En cad0 se asigna el apuntador a la primera ocurriencia de la cadena cad2. Si no existe se almacena NULL. */
while (cad0 != NULL)
{
    i++;
