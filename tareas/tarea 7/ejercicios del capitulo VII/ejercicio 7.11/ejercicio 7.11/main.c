...
/* Verifica.
El programa, al recibir como datos una cadena de caracteres y una posicion especifica en la cadena, determina si el caracter correspodiente es una letra minuscula. */
