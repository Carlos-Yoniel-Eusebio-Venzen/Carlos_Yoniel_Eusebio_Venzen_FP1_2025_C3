...
strcpy(cad1, cad0);
/* La funcion strcpy permite copiar una cadena de caracteres completa. En este caso se copia la cadena cad0 a cad1. Si el reservado para cad1 es menor que el cad0, se genera un error en la ejecuccion del programa. */
...
strcpy(cad1, "XX");
printf("\nPrueba de la funcion strcyp. Se copia la cadena XX a cad1: %s\n", cad1);

strncpy(cad2, cad0, 4);
cad2[4] = '\0';
/* La funcion strncpy permite copiar un numero determinado de caracteres a otra cadena de caracteres. En este caso se copian 4 caracteres de la cadena cad0 -segundo argumento- a cad2 -primer argumento. Siempre se debe incorporar al final de la cadena el caracter de terminacion. Si el espacio reservado para cad2 es menor que lo que se pretende copiar, se genera un error en la ejecuccion del programa. */
printf("\nPrueba de la funcion strncpy. Se copian 4 caracteres de cad0 a cad2: %s\n", cad2);

strcat(cad0, cad3);
/* La funcion strcat permite incorporar una cadena de caracteres a otra cadena dada. En este caso se agrega la cadena cad3 a cad0. Si el espacio reservado para cad0 es menor a lo que se debe almacenar se genera un error de ejecuccion. */
printf("\nPrueba de la funcion strcat. Se incorpora la cadena caad3 a cad0: %s\n", cad0);

strcat(cad1, "YY");
printf("\nPrueba de la funion strcat. Se incorpora la cadena YY a cad1: %s\n", cad1);
...
/* La funcion strstr se utiliza para localizar una cadena de caracteres dentro de otra cadena. Si la encuentra, regresa un apuntador al inicio de la primera ocurriencia de cadena localizada. De otra forma, refresa NULL. */
