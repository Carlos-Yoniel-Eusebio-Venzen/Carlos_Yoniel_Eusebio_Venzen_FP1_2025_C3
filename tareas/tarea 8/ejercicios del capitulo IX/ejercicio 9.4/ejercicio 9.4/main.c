...
{
    while (!feof(ap))
    /* Mientras no se detecte el fin de archivo se siguen leyendo cadenas de acaracteres. */
    {
        fgets(cad, 50, ap);
        /* Observa que la instruccion para leer cadenas requiere de tres argumentos. */
