...
/* Alumnos.
El programa almacena variables de tipo estructua alumno en un archivo. */
...
/* Esta funcion sirve para leer los datos de los alumnos utilizando una estructura tipo alumno, que se almacenara posteriormente en un archivo. */
{
alumno alu;
int i =  0, r;
