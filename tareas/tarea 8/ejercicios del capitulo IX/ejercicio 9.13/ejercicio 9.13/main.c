...
/* Cuenta caracteres.
El programa, al recibir como dato un archivo de texto  y un caractere, cuenta el numero de veces que se encuentra el caracter en el archivo. */
...
int cuenta(char car)
/* esta funcion setermina cuantas veces se encuentra el caracter en el archivo. */
{
int res, con = 0;
char p;
FILE *ar;
