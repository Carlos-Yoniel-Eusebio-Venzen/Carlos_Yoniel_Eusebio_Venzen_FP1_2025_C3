...
if((ar =  fopen("arc.txt", "r")) != NULL)   /* Se abre el archivo para lectura. */
    /* Observa que las dos instrucciones del programa 9.1 necsarias para abrir un archivo y verificar que este en realidad se haya abierto, se pueden agrupar en una sola instruccion. */
{
    while (!feof(ar))
